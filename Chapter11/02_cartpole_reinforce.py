...
GAMMA = 0.99
LEARNING_RATE = 0.01
EPISODES_TO_TRAIN = 4   # number of complete episodes we will use for training
...
def calc_qvals(rewards):    # calculate the discounted cumulative rewards (Q-values)
    res = []
    sum_r = 0.0
    # using dynamic programming from the end backwards
