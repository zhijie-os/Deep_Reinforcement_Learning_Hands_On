...
GRAD_BATCH = 64 # the batch size used to calculating the gradient
TRAIN_BATCH = 2 # how many gradient batches from child processes will be combined on every SGD update
...
if __name__ == "__main__":
    ...
    for proc_idx in range(PROCESSES_COUNT):
        ...
        data_proc = mp.Process(target=grads_func, args=p_args)   # create a gradient parallism process
        data_proc.start()
