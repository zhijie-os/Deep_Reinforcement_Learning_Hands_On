...
The kitchen part 1 is some text that varies. The kitchen part 1 is " chest, which looks typical, here.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0]. Classic TextWorld.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " gate leading west. You need an unblocked exit? You should try going north.".
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just sauntered into a chamber. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is " gate leading east. There is [if d_0 is open]an open[otherwise]a closed[end if]".
The chamber part 2 is some text that varies. The chamber part 2 is " passageway leading north.".
...
The office part 0 is some text that varies. The office part 0 is "You've just shown up in an office. You start to take note of what's in the room.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a shelf. [if there is something on the s_0]On the shelf you see [a list of things on the s_0].[end if]".
The office part 1 is some text that varies. The office part 1 is "[if there is nothing on the s_0]The shelf appears to be empty. Hm. Oh well[end if]".
The office part 2 is some text that varies. The office part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The office part 3 is some text that varies. The office part 3 is " passageway leading south. You don't like doors? Why not try going north, that entranceway is unblocked.".
...
The study part 0 is some text that varies. The study part 0 is "You've entered a study.
 ...
 You can see a display. Wow, isn't TextWorld just the best?[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The study part 1 is some text that varies. The study part 1 is "[if c_1 is open and the c_1 contains nothing] The display is empty, what a horrible day![end if]".
The study part 2 is some text that varies. The study part 2 is " You can make out a desk. Why don't you take a picture of it, it'll last longer! The desk is ordinary.[if there is something on the s_1] On the desk you see [a list of things on the s_1].[end if]".
...
The description of o_0 is "The Comic Strip Calendar is clean.".
...
Test quest0_0 with "take latchkey / unlock gate with latchkey / open gate / go east / lock chest with key"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, pick-up the latchkey from the floor of the chamber. After that, unlock the gate. And then, o".
The objective part 1 is some text that varies. The objective part 1 is "pen the gate. If you have opened the gate, make an attempt to head east. And then, look and see that the chest in the kitchen is locked. Once that's all handled, you can stop!".
