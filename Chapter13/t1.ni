...
Test quest0_0 with "go east / go south / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to try to venture east. Then, venture south. After that, try to go to th".
The objective part 1 is some text that varies. The objective part 1 is "e south. Once you succeed at that, try to go west. If you can finish that, pick-up the coin from the floor of the chamber. Once that's all handled, you can stop!".
